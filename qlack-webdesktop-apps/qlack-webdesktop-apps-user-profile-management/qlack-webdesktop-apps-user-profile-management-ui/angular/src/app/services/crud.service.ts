...
export class CrudService<T> {
  ...
  save(object: T) {
    return this.http.post(`${this.contextPath}` + `${AppConstants.API_SECURED_ROOT}/${this.endpoint}`, object);
  }
  ...
  get(id: any): Observable<T> {
    return this.http.get<T>(`${this.contextPath}` + `${AppConstants.API_SECURED_ROOT}/${this.endpoint}/${id}`);
  }

  getFirst(): Observable<T> {
    return this.http.get<T>(`${this.contextPath}` + `${AppConstants.API_SECURED_ROOT}/${this.endpoint}`);
  }

  delete(id: any): Observable<any> {
    return this.http.delete(`${this.contextPath}` + `${AppConstants.API_SECURED_ROOT}/${this.endpoint}/${id}`);
  }

  deleteAll(): Observable<any> {
    return this.http.delete(`${this.contextPath}` + `${AppConstants.API_SECURED_ROOT}/${this.endpoint}`);
  }

  upload(form: FormGroup): Observable<any> {
    return this.qForms.uploadForm(this.http, form,
      `${this.contextPath}` + `${AppConstants.API_SECURED_ROOT}/${this.endpoint}`, false);
  }
}
